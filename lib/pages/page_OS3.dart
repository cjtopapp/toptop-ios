...
class PageOS3 extends StatefulWidget {
  const PageOS3({super.key});
  @override
  State<PageOS3> createState() => _PageOS3State();
}

class _PageOS3State extends State<PageOS3> {
  ...
  void initState() {
    ...
    _videoController = VideoPlayerController.network(
      'https://res.cloudinary.com/duvoimzkv/video/upload/opening_qcj1yb.mp4',   // 2.0.6
    )..initialize().then((_) {
      setState(() {
