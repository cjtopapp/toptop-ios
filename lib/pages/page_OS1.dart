...
class PageOS1 extends StatefulWidget {
  const PageOS1({super.key});
  @override
  State<PageOS1> createState() => _PageOS1State();
}

class _PageOS1State extends State<PageOS1> {
  ...
  void initState() {
    ...
    _videoController = VideoPlayerController.network(
      'https://res.cloudinary.com/dvax38khk/video/upload/v1737937792/OS1_intro_d1kbpy.mp4',
    )..initialize().then((_) {
      setState(() {
