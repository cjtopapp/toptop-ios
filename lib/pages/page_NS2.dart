...
class PageNS2 extends StatefulWidget {
  const PageNS2({super.key});
  @override
  State<PageNS2> createState() => _PageNS2State();
}

class _PageNS2State extends State<PageNS2> {
  ...
  void initState() {
    ...
    _videoController = VideoPlayerController.network(
      'https://res.cloudinary.com/dvax38khk/video/upload/v1737938455/NS2_intro_jqmybk.mp4',
    )..initialize().then((_) {
      setState(() {
